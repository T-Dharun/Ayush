...
import { register, login, sendOtp, verifyOtp, forgotPassword, resetPassword } from "../../services/authService.jsx";
...
function Login({ isSignUp, onClose }) {
    ...
    const handleResetPassword = async () => {
        ...
        try {
            ...
            await resetPassword({ mobile, otp: forgotPasswordOtpRef.current.value, newPassword });
    ...
    return (
        <Components.Container>
            ...
            <Components.SignInContainer signinIn={signIn}>
                {isForgotPassword ? (
                    otpMode ? (
                        <Components.Form onSubmit={(e) => { e.preventDefault(); handleResetPassword(); }}>
                            <Components.Title>Reset Password</Components.Title>
                            <Components.Input type='number' placeholder='Enter OTP' ref={forgotPasswordOtpRef} />
                            <Components.Input type='password' placeholder='New Password' value={newPassword} onChange={(e) => setNewPassword(e.target.value)} />
                        ...
                        <Components.Form onSubmit={(e) => { e.preventDefault(); handleForgotPassword(); }}>
                    ...
                    <Components.Form onSubmit={(e) => { e.preventDefault(); handleSignIn(); }}>
                        ...
                        {error && <p style={{ color: 'red' }}>{error}</p>}
                        <Components.Anchor onClick={() => setIsForgotPassword(true)}>Forgot your password?</Components.Anchor>
                        <Components.Button type="submit" disabled={isLoading}>
